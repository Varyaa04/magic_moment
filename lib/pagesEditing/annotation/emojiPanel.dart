...
class _EmojiPanelState extends State<EmojiPanel> {
  ...
  Future<void> _updateImage(Uint8List newImage, {
    ...
    if (widget.onUpdateImage != null) {
      await widget.onUpdateImage!(newImage, action: action,
          ...
          if (_selectedCategory == 'Custom' && index == 0) {
            return GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(
                    Icons.add_photo_alternate, color: Colors.white, size: 40),
              ),
            );
          }
          final adjustedIndex = _selectedCategory == 'Custom'
              ? index - 1
              : index;
            ...
            child: Container(
              ...
              child: sticker.isAsset
                ...
                errorBuilder: (context, error, stackTrace) {
                  debugPrint('Error loading asset sticker in grid: ${sticker
                      .path}, $error');
                ...
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) {
                  debugPrint('Error loading gallery sticker in grid: ${sticker
                      .path}, $error');
                  return const Icon(Icons.error, color: Colors.red, size: 30);
                },
              ),
  ...
  Future<void> _applyChanges() async {
    try {
      ...
      final boundary = _imageKey.currentContext
