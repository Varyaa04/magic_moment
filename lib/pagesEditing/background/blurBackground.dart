...
class _BlurBackgroundPageState extends State<BlurBackgroundPage> {
    ...
    try {
      ...
      if (mounted) {
        ...
        final history = EditHistory(
          ...
          operationParameters: {'operation': 'blur_bg'},
        ...
        await widget.onUpdateImage(
          ...
          operationType: 'background',
          parameters: {'operation': 'blur_bg', 'historyId': historyId},
        );
  ...
  Future<Uint8List> _callClipDrop(Uint8List imageBytes) async {
    final localizations = AppLocalizations.of(context);
    try {
      final uri = Uri.parse('https://clipdrop-api.co/blur-background/v1');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations?.blurBackgroundTitle ?? 'Blur Background'),
        leading: IconButton(
      ...
      body: Center(
        child: _isLoading
          ...
          children: [
            ...
            Text(
              localizations?.blurringBackground ?? 'Blurring background...',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: localizations?.blurImageTooltip ?? 'Pick Image',
