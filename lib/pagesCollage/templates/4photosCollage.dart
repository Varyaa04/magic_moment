  ...
  Widget buildLayout(Size size) {
    ...
    List<Rect> getBounds(int layoutIndex) {
      switch (layoutIndex) {
        ...
        case 3: // Большой слева, три маленьких справа
          return [
        ...
        case 4: // Большой верх, три маленьких низа
          return [
